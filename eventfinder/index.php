    ...
    <section class="row justify-content-center coming-section">
        ...
        <div class="col-10 img-padding">
            <div class="row">
                ...
                <div class="col-sm-3 ">
                    <img src="./img/ev1.jpg" alt="imagen sobre forum" class="img-size">
                    <p><span class="bold-img">Lorem ipsum dolor sit amet </span> <br>
                        Union, Cartago / May 15th <br>
                        6pm - 10pm <br>
                        <span class="bold-img">FREE</span>
                    </p>
                </div>
                ...
                <div class="col-sm-3 ">
                    <img src="./img/ev3.jpg" alt="imagen sobre comida" class="img-size">
                    <p><span class="bold-img">Lorem ipsum dolor sit amet </span> <br>
                        San Pedro, San José / May 18th
                        11am - 2pm <br>
                        <span class="bold-img">$2 per person </span> <br>
                    </p>
                </div>
